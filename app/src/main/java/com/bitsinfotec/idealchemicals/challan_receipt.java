...
public class challan_receipt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringBuffer buffer = new StringBuffer("http://wesoftech.com/IdealChemical/receipts/challan_receipt.php");
